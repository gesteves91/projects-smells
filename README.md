...
1. Each developer has its own [tab](https://docs.google.com/spreadsheets/d/1nihLepeKJ8JCbmHsSm3D92DMdNKKppCFHWgCHMU3uLk/edit?usp=sharing) in the Google Sheets. The tab is named after each of you. **Please, only fill out the tab with your name**. The developers are: Aline, Amanda, Daniel, Denis, Fábio, Felipe, Fernando, Gustavo, Henrique, Igor, João Paulo, Johnathan, Paulo, Pedro, and Rafa.
